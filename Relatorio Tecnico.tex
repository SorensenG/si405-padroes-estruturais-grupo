...
\begin{titlepage}
  ...
  {\large Tema: Sistema de Cobrança Corporativa}\\[0.2cm]
  {\large Produto: refatoração arquitetural em Java}\\[0.2cm]
...
\toprule
\textbf{Parte} & \textbf{Responsáveis} \\
\midrule
...
Refatoração do CobrancaService e resolvedor de gateways & Daniel, Davie, Hugo, Gabriel \\
...
\bottomrule
\end{tabular}
\caption{Organização do trabalho do grupo.}
\end{table}
